...
<div class="container-fluid">
    <div class="Pearl">
        <div class="container">
            <div class="pearl_main">
                <h1>The Paper <span> Pearl</span></h1>
                <p>Logan would love this {{$user->name}} contact info.</p>
                @if(session()->has('success'))
                    <div class="alert alert-success mb-3 text-center font-weight-bold">
                        {{ session()->get('success') }}
                    </div>
                @endif
                <div class="pearl_form">
                    <div class="row">
                        <form action="{{ route('contacts.post') }}" method="POST">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="peral_input">
                                    <select name="country" autocomplete="country" class="form-control" required>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="peral_input">
                                    <input type="date"  name="birthday" placeholder="Date of Birth" class="form-control" required>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="pere_cont">
                                    <p>This form is protected by reCAPTCHA and your info will not be shared with anyone.</p>
                                </div>
                            </div>
                        </form>
                    </div>
